...
class DoctorAvailability(models.Model):
    ...
    # NEW fields for weekly recurrence
    ...
    recurrence_end_date = models.DateField(
        null=True, blank=True,
        help_text="Optional: stop recurring after this date"
    )
    class Meta:
    ...
    def save(self, *args, **kwargs):
        ...
        if self.is_recurring and self.recurrence_day_of_week is None:
            self.recurrence_day_of_week = self.start_time.weekday()  # auto-set from start_time
        super().save(*args, **kwargs)
    def __str__(self):
