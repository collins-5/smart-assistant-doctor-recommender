...
import { Animated, BackHandler, Dimensions, Easing, Keyboard, Modal, PanResponder, Platform, SafeAreaView, StatusBar, StyleSheet, TouchableOpacity, View, } from 'react-native';
...
export default forwardRef(function ActionSheet(_a, ref) {
    var _b, _c;
    var _d = _a.animated, animated = _d === void 0 ? true : _d, _e = _a.closeOnPressBack, closeOnPressBack = _e === void 0 ? true : _e, _f = _a.springOffset, springOffset = _f === void 0 ? 50 : _f, _g = _a.elevation, elevation = _g === void 0 ? 5 : _g, _h = _a.defaultOverlayOpacity, defaultOverlayOpacity = _h === void 0 ? 0.3 : _h, _j = _a.overlayColor, overlayColor = _j === void 0 ? 'black' : _j, _k = _a.closable, closable = _k === void 0 ? true : _k, _l = _a.closeOnTouchBackdrop, closeOnTouchBackdrop = _l === void 0 ? true : _l, onTouchBackdrop = _a.onTouchBackdrop, _m = _a.drawUnderStatusBar, drawUnderStatusBar = _m === void 0 ? false : _m, _o = _a.gestureEnabled, gestureEnabled = _o === void 0 ? false : _o, _p = _a.isModal, isModal = _p === void 0 ? true : _p, _q = _a.snapPoints, snapPoints = _q === void 0 ? [100] : _q, _r = _a.initialSnapIndex, initialSnapIndex = _r === void 0 ? 0 : _r, _s = _a.overdrawEnabled, overdrawEnabled = _s === void 0 ? true : _s, _t = _a.overdrawFactor, overdrawFactor = _t === void 0 ? 15 : _t, _u = _a.overdrawSize, overdrawSize = _u === void 0 ? 100 : _u, _v = _a.zIndex, zIndex = _v === void 0 ? 999 : _v, _w = _a.keyboardHandlerEnabled, keyboardHandlerEnabled = _w === void 0 ? true : _w, ExtraOverlayComponent = _a.ExtraOverlayComponent, payload = _a.payload, safeAreaInsets = _a.safeAreaInsets, routes = _a.routes, initialRoute = _a.initialRoute, onBeforeShow = _a.onBeforeShow, enableRouterBackNavigation = _a.enableRouterBackNavigation, onBeforeClose = _a.onBeforeClose, _x = _a.enableGesturesInScrollView, enableGesturesInScrollView = _x === void 0 ? true : _x, disableDragBeyondMinimumSnapPoint = _a.disableDragBeyondMinimumSnapPoint, props = __rest(_a, ["animated", "closeOnPressBack", "springOffset", "elevation", "defaultOverlayOpacity", "overlayColor", "closable", "closeOnTouchBackdrop", "onTouchBackdrop", "drawUnderStatusBar", "gestureEnabled", "isModal", "snapPoints", "initialSnapIndex", "overdrawEnabled", "overdrawFactor", "overdrawSize", "zIndex", "keyboardHandlerEnabled", "ExtraOverlayComponent", "payload", "safeAreaInsets", "routes", "initialRoute", "onBeforeShow", "enableRouterBackNavigation", "onBeforeClose", "enableGesturesInScrollView", "disableDragBeyondMinimumSnapPoint"]);
    snapPoints =
    ...
    var panHandlerRef = useRef(null);
    var closing = useRef(false);
    var draggableNodes = useRef([]);
    var sheetLayoutRef = useRef(null);
    var _y = useState({
    ...
    useEffect(function () {
        ...
        if (drawUnderStatusBar || props.onChange) {
            animationListener = animations.translateY.addListener(function (value) {
                var _a;
                var correctedValue = value.value > minTranslateValue.current
            ...
            <GestureHandlerRoot isModal={isModal} style={styles.parentContainer} pointerEvents={(props === null || props === void 0 ? void 0 : props.backgroundInteractionEnabled) ? 'box-none' : 'auto'}>
              <PanGestureRefContext.Provider value={context}>
                ...
                styles.parentContainer,
                {
                    ...
                    <Animated.View pointerEvents="box-none" style={__assign(__assign({ borderTopRightRadius: (containerStyle === null || containerStyle === void 0 ? void 0 : containerStyle.borderTopRightRadius) || 10, borderTopLeftRadius: (containerStyle === null || containerStyle === void 0 ? void 0 : containerStyle.borderTopLeftRadius) || 10, backgroundColor: (containerStyle === null || containerStyle === void 0 ? void 0 : containerStyle.backgroundColor) || 'white', borderBottomLeftRadius: (containerStyle === null || containerStyle === void 0 ? void 0 : containerStyle.borderBottomLeftRadius) || undefined, borderBottomRightRadius: (containerStyle === null || containerStyle === void 0 ? void 0 : containerStyle.borderBottomRightRadius) || undefined, borderRadius: (containerStyle === null || containerStyle === void 0 ? void 0 : containerStyle.borderRadius) || undefined, width: (containerStyle === null || containerStyle === void 0 ? void 0 : containerStyle.width) || '100%' }, getElevation(typeof elevation === 'number' ? elevation : 5)), { flex: undefined, height: dimensions.height, maxHeight: dimensions.height, paddingBottom: keyboard.keyboardShown
                ...
                transform: [
                    {
                      ...
                      {dimensions.height === 0 ? null : (<PanGestureHandler {...panHandlers} ref={panHandlerRef}>
                          <Animated.View {...handlers.panHandlers} onLayout={onSheetLayout} ref={panViewRef} testID={(_c = props.testIDs) === null || _c === void 0 ? void 0 : _c.sheet} style={[
                    styles.container,
                    {
